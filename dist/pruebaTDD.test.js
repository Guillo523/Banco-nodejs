...
describe("pruebaCuenta", () => {
    let prueba1;
    beforeEach(() => prueba1 = new account_1.Account(11223344155, "8.434.588", "Guillermo"));
    it("should have all", () => {
...
describe("pruebaTarea", () => {
    let cuentaGmo;
    beforeEach(() => cuentaGmo = new account_1.Account(11223344155, "8434588", "Guilermo"));
    describe("depositar", () => {
        ...
        it("esto no deberia depositar numeros negativos", () => {
            const cuentaGmo = new account_1.Account(11223344155, "8434588", "Guillermo");
    ...
    describe("retirar", () => {
        it("esto deberia retirar 400 Us", () => {
            const cuentaGmo = new account_1.Account(11223344155, "8434588", "Guilermo");
    ...
    describe("transferir", () => {
        it("Debe poder transferiri 300 Us", () => {
            const cuenta1 = new account_1.Account(11223344155, "43169974", "juliana");
            const cuenta2 = new account_1.Account(11223344155, "71245633", "Carlos");
    ...
    describe("validarCuenta", () => {
        it("la cuenta es incorrecta porque la longitud es diferente de 9", () => {
            const cuenta = new account_1.Account(11223344155, "8434588", "sergio");
            const resultado = cuenta.validar();
            resultado.should.be.equal(false);
        });
        it("la cuenta es correcta porque la longitud es igual a 9", () => {
            const cuenta = new account_1.Account(834458901, "6665544", "maria");
    ...
    describe("validacionDigitos", () => {
        ...
        it("el número correcto es", () => {
            const validarnum = new validator_1.validator();
...
//# sourceMappingURL=pruebaTDD.test.js.map